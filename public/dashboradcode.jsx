          ...
          <div className="table-full-width table-responsive">
            <Table>
              <tbody>
                <tr>
                  <td>
                    <p className="title">Threat name: {data.name}</p>
                    <p className="text-muted">
                      OS: {data.OS}
                    </p>
                    <p className="text-muted">
      ...
      <>
        <div className="content">
          ...
          <Row>
            ...
            <Col xs="2">
              <Card className="card-chart">
                <img src="/642.png" width="50" height="50"/>
                <h6>Others OS: {this.osUnknown && this.osUnknown.length}</h6>
              </Card>
            </Col>
          ...
          <Row>
            <Col lg="6" md="12">
              <Card className="card-tasks">
                <CardHeader>
                  <h6 className="title d-inline">Connected Host</h6>
                  <p className="card-category d-inline"> EDM</p>
                  <UncontrolledDropdown>
                    <DropdownToggle
                      caret
                      className="btn-icon"
            ...
            {/* <Col lg="6" md="12">
              ...
              <Card className="card-tasks">
                <CardHeader>
                  <h6 className="title d-inline">Alerts Management</h6>
                ...
                <CardHeader>
                  <Row>
                    <Col className="text-left" sm="6">
                      <h5 className="card-category">1</h5>
                      <CardTitle tag="h2">Network Protocol Uasage</CardTitle>
                    </Col>
                    <Col sm="6">
                      <ButtonGroup
            ...
            <Col xs="6">
              ...
              <Card className="card-tasks">
                <CardHeader>
                  <h6 className="title d-inline">Threat Management</h6>
                  <p className="card-category d-inline">today</p>
                  <UncontrolledDropdown>
                    <DropdownToggle
                      caret
...
protocolUsage = () => {
  ...
  if(this.protocol_sent == true) {
  protocol.push(this.state.fetchedData.protocol_usage[i].sent);
  
  }
  else {
  protocolReceived.push(this.state.fetchedData.protocol_usage[i].received);
  }
